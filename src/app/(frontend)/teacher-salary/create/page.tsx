...
export default function CreateTeacherSalaryPage() {
  ...
  useEffect(() => {
    fetch('/api/users?limit=100&where[role][equals]=teacher')
      .then((res) => res.json())
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.errors?.[0]?.message || 'Failed to create salary record.')
      }
    } catch (err) {
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12">
            ...
            <div className="mt-16 pt-10 border-t border-gray-50 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center space-x-4 w-full md:w-auto">
                ...
                <button
                  type="submit"
                  disabled={loading || !formData.teacher}
